...
public class HomeController {
	...
	public String updateRestaurant() {
	  ...
	  @RequestMapping(value = "/DisplayIdDesign")
		public String  displaybyId(){
					return "DisplayIdDesign";
		
	}
	  
	  @RequestMapping(value = "/dispID")
	  public String displaybyId(Model model ,@RequestParam("Restaurant_id") int Restaurant_id) {
		  
		  Restaurant rest = restaurantdao.getListbyId(Restaurant_id);
		  model.addAttribute("List1", rest);
		  return "Display11";
	  }
